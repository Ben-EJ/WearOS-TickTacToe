...
public class AILogic extends Activity {
    ...
    public boolean ruleSetUpWin(ArrayList<Button> line){
        ...
        if(line.get(1).getText() == "X" && line.get(2).getText() == "" && line.get(0).getText() == ""){
            line.get(0).setText("O");
            return true;
        }
        if(line.get(0).getText() == "X" && line.get(2).getText() == "" && line.get(1).getText() == ""){
            line.get(1).setText("O");
            return true;
        }
        return false;
    ...
    public boolean aiMakeMove(Grid grid){
